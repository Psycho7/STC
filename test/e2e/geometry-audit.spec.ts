...
// defect -- the stamp-staleness comments in crossings.ts record ~1 unit of
// port-model noise between a reconstruction and React Flow's measured handles,
// and set their own guard well above it for the same reason.
//

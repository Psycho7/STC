...
1. CORRECTNESS of the presented information: chips attached to the wrong line or floating in empty space; a chip overlapping/hiding another chip or card text; edges slicing through node cards; arrowheads pointing the wrong way; junction dots off their trunk; rate chips that contradict the target card's input rows (cross-check numbers where legible); the same item rendered in confusingly different colors, or two different items in near-identical colors on crossing lines.
